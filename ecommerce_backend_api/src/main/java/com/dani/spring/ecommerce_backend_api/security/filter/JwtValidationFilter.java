...
public class JwtValidationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try{
            // En caso de ser endpoint publico
            ...
            //En caso de no ser endpoint publco
            if (header == null || !header.startsWith(TokenJwtData.PREFIX_TOKEN)){
    ...
    private void tokenManagement(String header) throws StreamReadException, DatabindException, IOException{
